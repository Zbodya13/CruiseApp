...
<div class="col-sm-4"><ul>
 <li><a href="?sessionLocale=en&action=userListExcursions"><fmt:message key="en" /></a></li>
 <li><a href="?sessionLocale=ua&action=userListExcursions"><fmt:message key="ua" /></a></li>
