...
<div class="col-sm-4"><ul>
 <li><a href="?sessionLocale=en&action=availableListExcursions"><fmt:message key="en" /></a></li>
 <li><a href="?sessionLocale=ua&action=availableListExcursions"><fmt:message key="ua" /></a></li>
 <li><fmt:message key="currentCash" />${sessionScope.cash}</li> 
</ul></div>
<div class="col-sm-4"><ul>
